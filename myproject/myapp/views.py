...
data = pd.read_csv(r"C:\Users\DEVADHARSHINI K\myproject\drug_complete_dataset.csv")
...
# Load the data
data_path = r"C:\Users\DEVADHARSHINI K\myproject\drug_complete_dataset.csv"
...
# Load datasets
df_kerala = pd.read_csv(r"C:\Users\DEVADHARSHINI K\myproject\sorted_landslide_data(1).csv", encoding='latin1')
...
df_up = pd.read_csv(r"C:\Users\DEVADHARSHINI K\myproject\earth_sort.csv", encoding='latin1')
...
def hiv(request):
    # Load your dataset
    df = pd.read_csv(r'C:\Users\DEVADHARSHINI K\myproject\HIV.csv')
